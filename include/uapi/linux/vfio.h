...
/* Revoke one vector, or all vectors when @vector is IMS_VECTOR_ALL. */
#define VFIO_DEVICE_FEATURE_IDXD_SIOV_IMS_REVOKE	3
	__u32 vector;
#define VFIO_DEVICE_FEATURE_IDXD_SIOV_IMS_VECTOR_ALL	(~0U)
...
#define VFIO_DEVICE_FEATURE_IDXD_SIOV_IMS_F_REVOKED	(1 << 4)
	__u32 __reserved;
};
